...
if P.dataset=="MVTecAD":
    ...
    train_set, test_set, image_size, n_classes = get_dataset(P=P, dataset=P.dataset, eval=True, download=True, image_size=image_size_, labels=normal_labels, test_id=P.test_id)
