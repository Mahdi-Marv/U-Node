...
if P.dataset=="MVTecAD":
    ...
    train_set, test_set, image_size, n_classes = get_dataset(P, dataset=P.dataset, eval=True, download=True, image_size=image_size_, labels=normal_labels, test_id=P.test_id)
P.image_size = image_size
P.n_classes = n_classes


visualize_random_samples_from_clean_dataset(test_set, f'visualize for test set {P.test_id}')
