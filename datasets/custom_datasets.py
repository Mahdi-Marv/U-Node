    ...
    def __init__(self, transform, is_train=True, test_id=1):
        ...
        if is_train:
            ...
            if test_id == 1:
                ...
                test_path_normal = node0_test_normal
                test_path_anomaly = node0_test_anomaly
                ...
                shifted_test_path_normal = node3_test_normal + node4_test_normal + node1_test_normal + node2_test_normal
                shifted_test_path_anomaly = node3_test_anomaly + node4_test_anomaly + node2_test_anomaly + node1_test_anomaly
